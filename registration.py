...
keys = {'SMART_VERT': [{'label': 'Merge Last', 'keymap': 'Mesh', 'idname': 'machin3.smart_vert', 'type': 'ONE', 'value': 'PRESS', 'properties': [('mode', 'MERGE'), ('mergetype', 'LAST'), ('slideoverride', False)]},
        ...
        'SELECT': [{'label': 'Select Children', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'DOWN_ARROW', 'value': 'PRESS', 'properties': [('direction', 'DOWN'), ('include_selection', False), ('unhide', False)]},
                   {'label': 'Select Parent + Children', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'DOWN_ARROW', 'value': 'PRESS', 'shift': True, 'properties': [('direction', 'DOWN'), ('include_selection', True), ('unhide', False)]},
                   ...
                   {'label': 'Select Parent + Children + Unhide', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'DOWN_ARROW', 'value': 'PRESS', 'shift': True, 'ctrl': True, 'properties': [('direction', 'DOWN'), ('include_selection', True), ('unhide', True)]},

                   {'label': 'Select Up', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'UP_ARROW', 'value': 'PRESS', 'shift': False, 'ctrl': False, 'properties': [('direction', 'UP'), ('include_selection', False), ('unhide', False)]},
                   {'label': 'Select Up', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'UP_ARROW', 'value': 'PRESS', 'shift': True, 'ctrl': False, 'properties': [('direction', 'UP'), ('include_selection', True), ('unhide', False)]},
                   {'label': 'Select Up', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'UP_ARROW', 'value': 'PRESS', 'shift': False, 'ctrl': True, 'properties': [('direction', 'UP'), ('include_selection', False), ('unhide', True)]},
                   {'label': 'Select Up', 'keymap': 'Object Mode', 'idname': 'machin3.select_hierarchy', 'type': 'UP_ARROW', 'value': 'PRESS', 'shift': True, 'ctrl': True, 'properties': [('direction', 'UP'), ('include_selection', True), ('unhide', True)]}],
